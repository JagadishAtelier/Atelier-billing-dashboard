            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <div style={{ display: "grid", gap: 8 }}>
                {commonColorSchemes.map((scheme, index) => (
                  <div
                    key={index}
                    onClick={() => handleApplyCommonScheme(index, scheme.name)}
                    style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: 10, borderRadius: 8, border: "1px solid #eef2f6", cursor: "pointer" }}
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
